...
const SuppliersPage = lazy(() =>
  import('@/modules/suppliers/suppliers-page').then((m) => ({
    default: m.SuppliersPage,
  }))
)
const CustomersPage = lazy(() =>
  import('@/modules/customers/customers-page').then((m) => ({
    default: m.CustomersPage,
  }))
)
const ServicesPage = lazy(() =>
  import('@/modules/services/services-page').then((m) => ({
    default: m.ServicesPage,
  }))
)
const ProductsPage = lazy(() =>
  import('@/modules/products/products-page').then((m) => ({
...
const BrandModelsPage = lazy(() =>
  import('@/modules/brand-models/brand-models-page').then((m) => ({
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            element: <PermissionRoute permission="suppliers.view" />,
          ...
          {
            element: <PermissionRoute permission="services.view" />,
