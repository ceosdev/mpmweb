...
- Specs de features, organizadas por contexto:
  ...
  - [`docs/spec/financeiro/`](docs/spec/financeiro/) — telas do financeiro (001 = contas a pagar, 002 = baixa, 003 = pagamento em lote).
